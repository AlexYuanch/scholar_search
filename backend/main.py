...
NODE_SIGNAL = {
    ...
    "collect_orcid_identity": "orcid_audit",
    "collect_works": "raw_works",
    "dedup_works": "deduped_works",
    "collect_crossref": "source_audit",
    "collect_dblp": "source_audit",
    "collect_google_scholar": "source_audit",
    "adjudicate_sources": "data_audit",
    "resolve_work_identity": "identity_audit",
    ...
    "orchestrate_workers": "orchestrator_tasks",
    "analysis_worker": "worker_outputs",
    "aggregate_workers": "orchestrator_analysis",
    "generate_report": "profile_summary",
    "agent_review_report": "agent_review",
    "optimize_report": "profile_summary",
...
NODE_USER_STAGE = {
    ...
    "collect_orcid_identity": "verify_identity",
    "collect_works": "aggregate_outputs",
    "dedup_works": "aggregate_outputs",
    "collect_crossref": "aggregate_outputs",
    "collect_dblp": "aggregate_outputs",
    "collect_google_scholar": "aggregate_outputs",
    "adjudicate_sources": "aggregate_outputs",
    "resolve_work_identity": "verify_identity",
    ...
    "orchestrate_workers": "analyze_trajectory",
    "analysis_worker": "analyze_trajectory",
    "aggregate_workers": "analyze_trajectory",
    "generate_report": "analyze_trajectory",
    "agent_review_report": "verify_evidence",
    "optimize_report": "verify_evidence",
...
PROGRESS_ANCHORS = {
    "fetch_profile": 6,
    "collect_orcid_identity": 14,
    "collect_works": 24,
    "dedup_works": 30,
    "collect_crossref": 38,
    "collect_dblp": 43,
    "collect_google_scholar": 46,
    "adjudicate_sources": 48,
    "resolve_work_identity": 51,
    "plan_agents": 53,
    ...
    "build_graph": 87,
    "orchestrate_workers": 89,
    "analysis_worker": 91,
    "aggregate_workers": 93,
    "generate_report": 95,
...
PROGRESS_MESSAGES = {
    ...
    "collect_orcid_identity": ["正在通过 ORCID 公共记录核验身份论文..."],
    "collect_works": [
    ...
    "collect_dblp": ["正在通过 DBLP 核对计算机领域论文记录..."],
    "collect_google_scholar": ["正在核对可用的 Google Scholar 记录..."],
    "adjudicate_sources": ["正在合并来源并记录数据差异..."],
    "resolve_work_identity": ["正在依据 ORCID、论文和稳定合作者净化论文集..."],
    ...
    "orchestrate_workers": ["正在根据当前学者证据拆分专业分析任务..."],
    "analysis_worker": ["专业分析 Agent 正在处理代表作、合作或机构证据..."],
    "aggregate_workers": ["正在汇总各专业 Agent 的可追溯结论..."],
    "generate_report": ["正在生成画像总结..."],
    "agent_review_report": ["正在由证据审查 Agent 复核分析结论..."],
    "optimize_report": ["正在依据审查意见修订画像总结..."],
