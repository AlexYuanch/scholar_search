const zh: Record<string, string> = {
  ...
  "auth.sign_in": "登录",
  "auth.sign_out": "退出",
  "auth.magic_link_desc": "输入 QQ 邮箱或其他邮箱，我们会发送一次性登录链接。",
  "auth.email_placeholder": "name@example.com",
  "auth.send_link": "发送魔法链接",
  "auth.email_sent": "登录链接已发送，请前往邮箱查收。",
  "auth.failed": "登录邮件发送失败",
  "auth.not_configured": "当前环境已关闭邮箱登录。",
